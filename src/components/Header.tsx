      ...
      <header className='flex justify-between items-center py-4 px-6 bg-white border-b-4 border-indigo-600'>
        ...
        <div className='flex items-center'>
          <div className='relative'>
            <button
              className='relative block h-8 w-8 rounded-full overflow-hidden border border-gray-300 shadow focus:outline-none'
            ...
            {isOpenMenu && (
              <div className='absolute right-0 mt-2 w-48 bg-white rounded-md overflow-hidden shadow-xl z-10'>
                <button
                  className='w-full px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white'
                  onClick={signout}
                >
                  Signout
                </button>
